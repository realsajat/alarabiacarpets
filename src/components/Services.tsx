...
import { Delivery, Installation } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="p-8 text-center">
            <Delivery className="w-16 h-16 text-secondary mb-4 mx-auto" />
          ...
          <Card className="p-8 text-center">
            <Installation className="w-16 h-16 text-secondary mb-4 mx-auto" />
